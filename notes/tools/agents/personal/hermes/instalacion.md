...
Hermes **no es un agente de programación** en el sentido de [Claude Code](/notes/tools/agents/coding/claude-code/instalacion), [Codex CLI](/notes/tools/agents/coding/codex/instalacion) u [opencode](/notes/tools/agents/coding/opencode/instalacion). Es un **agente personal persistente**: memoria de largo plazo entre sesiones, creación automática de *skills* reutilizables, planificador cron propio y conectores a Telegram, Discord, Slack, WhatsApp y Signal. Programar es una de las cosas que sabe hacer, no su razón de ser. La [comparativa](/notes/tools/agents/personal/hermes/comparativa) desarrolla dónde se solapa realmente con los agentes de código y dónde no.
:::
